...
const Charts: React.FC<ChartsProps> = ({ statistics }) => {
  ...
  console.log('Charts component received statistics:', statistics);
  ...
  ], [statistics.maleParticipants, statistics.femaleParticipants]);

  const eventData = useMemo(() => {
    return Object.entries(statistics.eventBreakdown)
  ...
  }, [statistics.eventBreakdown, statistics.eventGenderBreakdown]);

  const clubData = useMemo(() => {
    return Object.entries(statistics.clubBreakdown)
  ...
  }, [statistics.clubBreakdown]);
  
  console.log('Event data for charts:', eventData);
  console.log('Club data for charts:', clubData);
